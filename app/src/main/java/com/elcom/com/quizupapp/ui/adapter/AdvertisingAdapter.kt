...
import com.elcom.com.quizupapp.R.id.imageView
 ...
 */
class AdvertisingAdapter(val context : Context) : PagerAdapter() {

    private val mContext = context
    private var layoutInflater: LayoutInflater? = null
    private val images = arrayOf<Int>(R.drawable.test_logo_1, R.drawable.test_logo_2, R.drawable.test_logo_3)
