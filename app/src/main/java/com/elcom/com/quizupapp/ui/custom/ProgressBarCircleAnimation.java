 ...
 */
public class ProgressBarCircleAnimation extends ProgressBar {
    ...
    public ProgressBarCircleAnimation(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public ProgressBarCircleAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ProgressBarCircleAnimation(Context context) {
        super(context);
    }
        ...
        if (animator == null) {
            ...
            animator.addUpdateListener(new AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ProgressBarCircleAnimation.super.setProgress((Integer) animation.getAnimatedValue());
                }
            });
        } else
    ...
    public synchronized void setSecondaryProgress(int secondaryProgress) {
        ...
        if (animatorSecondary == null) {
            ...
            animatorSecondary.addUpdateListener(new AnimatorUpdateListener() {
                ...
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    ProgressBarCircleAnimation.super.setSecondaryProgress((Integer) animation
                            .getAnimatedValue());
                }
            });
        } else
